...
INSERT INTO weekly_check_ins_self (graduate_id, week_number, check_in_date, dimension_scores) VALUES
  ('cccc0002-0000-0000-0000-000000000002', 16, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_manager (manager_id, graduate_id, week_number, check_in_date, dimension_scores, questions_observed, manager_confidence) VALUES
  ('dddd0002-0000-0000-0000-000000000002', 'cccc0002-0000-0000-0000-000000000002', 16, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ('bbbb0003-0000-0000-0000-000000000003', 'cccc0002-0000-0000-0000-000000000002', 16,
   '{"collaboration":8.5,"reliability":8.8,"communication":8.0,"overall":8.5}'::jsonb),
  ('bbbb0004-0000-0000-0000-000000000004', 'cccc0002-0000-0000-0000-000000000002', 16,
   '{"collaboration":8.2,"reliability":9.0,"communication":7.8,"overall":8.3}'::jsonb);

-- ---- Priya Patel (g3) — week 10, steady ----
INSERT INTO weekly_check_ins_self (graduate_id, week_number, check_in_date, dimension_scores) VALUES
  ('cccc0003-0000-0000-0000-000000000003', 10, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_manager (manager_id, graduate_id, week_number, check_in_date, dimension_scores, questions_observed, manager_confidence) VALUES
  ('dddd0002-0000-0000-0000-000000000002', 'cccc0003-0000-0000-0000-000000000003', 10, CURRENT_DATE,
   '{"workQuality":7,"proactivity":6,"feedbackResponse":7,"overallRating":7}'::jsonb, 5, 7);

INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ('bbbb0001-0000-0000-0000-000000000001', 'cccc0003-0000-0000-0000-000000000003', 10,
   '{"collaboration":6.8,"reliability":7.0,"communication":6.5,"overall":6.8}'::jsonb),
  ('bbbb0003-0000-0000-0000-000000000003', 'cccc0003-0000-0000-0000-000000000003', 10,
...
INSERT INTO weekly_check_ins_self (graduate_id, week_number, check_in_date, dimension_scores) VALUES
  ('cccc0004-0000-0000-0000-000000000004', 14, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_manager (manager_id, graduate_id, week_number, check_in_date, dimension_scores, questions_observed, manager_confidence) VALUES
  ('dddd0001-0000-0000-0000-000000000001', 'cccc0004-0000-0000-0000-000000000004', 14, CURRENT_DATE,
   '{"workQuality":6,"proactivity":5,"feedbackResponse":6,"overallRating":6}'::jsonb, 3, 5);

INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ('bbbb0002-0000-0000-0000-000000000002', 'cccc0004-0000-0000-0000-000000000004', 14,
   '{"collaboration":5.5,"reliability":5.8,"communication":5.0,"overall":5.5}'::jsonb),
  ('bbbb0004-0000-0000-0000-000000000004', 'cccc0004-0000-0000-0000-000000000004', 14,
   '{"collaboration":5.2,"reliability":6.0,"communication":4.8,"overall":5.3}'::jsonb);

-- ---- James Park (g5) — week 11, accelerating ----
INSERT INTO weekly_check_ins_self (graduate_id, week_number, check_in_date, dimension_scores) VALUES
  ('cccc0005-0000-0000-0000-000000000005', 11, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_manager (manager_id, graduate_id, week_number, check_in_date, dimension_scores, questions_observed, manager_confidence) VALUES
  ('dddd0002-0000-0000-0000-000000000002', 'cccc0005-0000-0000-0000-000000000005', 11, CURRENT_DATE,
   '{"workQuality":8,"proactivity":7,"feedbackResponse":8,"overallRating":8}'::jsonb, 7, 8);

INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ('bbbb0001-0000-0000-0000-000000000001', 'cccc0005-0000-0000-0000-000000000005', 11,
   '{"collaboration":7.8,"reliability":7.5,"communication":7.2,"overall":7.5}'::jsonb),
  ('bbbb0003-0000-0000-0000-000000000003', 'cccc0005-0000-0000-0000-000000000005', 11,
   '{"collaboration":7.5,"reliability":8.0,"communication":7.0,"overall":7.5}'::jsonb);

-- ---- Emily Zhang (g6) — week 13, attention (overloaded) ----
INSERT INTO weekly_check_ins_self (graduate_id, week_number, check_in_date, dimension_scores) VALUES
  ('cccc0006-0000-0000-0000-000000000006', 13, CURRENT_DATE,
...
INSERT INTO weekly_check_ins_manager (manager_id, graduate_id, week_number, check_in_date, dimension_scores, questions_observed, manager_confidence) VALUES
  ('dddd0001-0000-0000-0000-000000000001', 'cccc0006-0000-0000-0000-000000000006', 13, CURRENT_DATE,
   '{"workQuality":6,"proactivity":5,"feedbackResponse":6,"overallRating":5}'::jsonb, 2, 5);

INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ('bbbb0002-0000-0000-0000-000000000002', 'cccc0006-0000-0000-0000-000000000006', 13,
   '{"collaboration":6.0,"reliability":6.5,"communication":5.8,"overall":6.0}'::jsonb),
  ('bbbb0004-0000-0000-0000-000000000004', 'cccc0006-0000-0000-0000-000000000006', 13,
...
INSERT INTO work_log_entries (graduate_id, week_number, project_name, skill_slugs, is_first_exposure) VALUES
  ('cccc0006-0000-0000-0000-000000000006', 13,
   'Year-end audit crunch',
   ARRAY['audit-planning', 'financial-statement-review'], false);
