...
INSERT INTO weekly_check_ins_peer (peer_id, graduate_id, week_number, dimension_scores) VALUES
  ...
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 1,
   '{"collaboration":6.5,"reliability":7.5,"communication":6.5,"overall":6.5}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 2,
   '{"collaboration":7.0,"reliability":7.8,"communication":6.8,"overall":7.0}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 3,
   '{"collaboration":6.8,"reliability":8.0,"communication":7.0,"overall":6.8}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 4,
   '{"collaboration":7.2,"reliability":7.5,"communication":7.2,"overall":7.0}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 5,
   '{"collaboration":7.0,"reliability":8.2,"communication":6.8,"overall":7.0}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 6,
   '{"collaboration":7.3,"reliability":7.8,"communication":7.0,"overall":7.2}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 7,
   '{"collaboration":7.0,"reliability":8.0,"communication":7.2,"overall":7.0}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 8,
   '{"collaboration":7.5,"reliability":8.0,"communication":7.0,"overall":7.2}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 9,
   '{"collaboration":7.8,"reliability":7.8,"communication":6.8,"overall":7.5}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 10,
   '{"collaboration":8.0,"reliability":8.2,"communication":7.0,"overall":7.5}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 11,
   '{"collaboration":7.8,"reliability":8.0,"communication":7.2,"overall":7.3}'::jsonb),
  ('pppp0001-0000-0000-0000-000000000001', 'gggg0001-0000-0000-0000-000000000001', 12,
   '{"collaboration":8.0,"reliability":8.0,"communication":7.0,"overall":7.5}'::jsonb),

  -- Jess Kim — weeks 1-12
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 1,
   '{"collaboration":7.0,"reliability":8.0,"communication":7.0,"overall":7.0}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 2,
   '{"collaboration":6.8,"reliability":8.2,"communication":7.2,"overall":7.0}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 3,
   '{"collaboration":7.2,"reliability":7.8,"communication":6.8,"overall":7.2}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 4,
   '{"collaboration":7.0,"reliability":8.0,"communication":7.0,"overall":7.0}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 5,
   '{"collaboration":7.2,"reliability":7.5,"communication":7.2,"overall":7.2}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 6,
   '{"collaboration":6.8,"reliability":8.0,"communication":7.0,"overall":7.0}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 7,
   '{"collaboration":7.5,"reliability":8.2,"communication":6.8,"overall":7.2}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 8,
   '{"collaboration":7.0,"reliability":8.0,"communication":7.2,"overall":7.0}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 9,
   '{"collaboration":7.5,"reliability":8.0,"communication":7.0,"overall":7.5}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 10,
   '{"collaboration":8.2,"reliability":7.8,"communication":7.2,"overall":7.8}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 11,
   '{"collaboration":8.0,"reliability":8.0,"communication":7.0,"overall":7.5}'::jsonb),
  ('pppp0002-0000-0000-0000-000000000002', 'gggg0001-0000-0000-0000-000000000001', 12,
   '{"collaboration":7.8,"reliability":8.2,"communication":7.2,"overall":7.5}'::jsonb);

-- Work log entries (columns: id, graduate_id, week_number, project_name, skill_slugs, is_first_exposure, created_at)
INSERT INTO work_log_entries (graduate_id, week_number, project_name, skill_slugs, is_first_exposure) VALUES
  ('gggg0001-0000-0000-0000-000000000001', 2,
   'Team onboarding documentation review',
   ARRAY['documentation', 'attention-detail'], false),
  ('gggg0001-0000-0000-0000-000000000001', 5,
   'Internal compliance training',
   ARRAY['aml-ctf', 'ethics'], false),
  ('gggg0001-0000-0000-0000-000000000001', 8,
   'Meridian audit engagement',
   ARRAY['audit-planning', 'documentation-standards'], true),
  ('gggg0001-0000-0000-0000-000000000001', 9,
   'Meridian audit fieldwork',
   ARRAY['fin-statements', 'audit-evidence'], false),
  ('gggg0001-0000-0000-0000-000000000001', 10,
